...
def main(arg_path):
    ...
    rank = index.index(train_sampler.ent2id['Hangzhou']) + 1
    print('\033[1;32mInteresting display! \033[0m')
    print('Use the trained KGE to predict entity')
    print("\033[1;32mQuery: \033[0m (ZhejiangUniversity, locatedinthecity, ?)")
    print(f"\033[1;32mTop 10 Prediction:\033[0m{top10_ent}")
    print(f"\033[1;32mGroud Truth: \033[0mHangzhou   \033[1;32mRank: \033[0m{rank}")
    print('This demo is powered by \033[1;32mNeuralKG \033[0m')
